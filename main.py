...
for made in range (much):
    print("just created 1")
    print('\033[30m' + "just created 1")
    print('\033[31m' + "just created 1")
    print('\033[32m' + "just created 1")
    print('\033[33m' + "just created 1")
    print('\033[34m' + "just created 1")
    print('\033[35m' + "just created 1")
    print('\033[36m' + "just created 1")
